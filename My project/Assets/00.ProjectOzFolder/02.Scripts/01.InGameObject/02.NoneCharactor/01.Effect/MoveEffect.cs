...
public class MoveEffect : EffectBased
{
    ...
    public override IEnumerator EffectContinue(int i, Vector3 vec3)
    {
        ...
        {
            float DashForce =
                Manager.Player.Inst.curPlayer.GetComponent<PlayerAbleCharacter>().Dash.applyforce;
    ...
    private IEnumerator DashEffectCoroutine(GameObject _obj)
    {
        yield return new WaitForSeconds
            (Manager.Player.Inst.curPlayer.GetComponent<PlayerAbleCharacter>().Dash.applyTime);
